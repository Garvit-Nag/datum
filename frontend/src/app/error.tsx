...
export default function GlobalError({
  ...
  return (
    <main className="bg-grid-fade relative flex min-h-screen flex-col items-center justify-center p-6 text-center">
      <div className="relative mb-6 flex h-20 w-20 items-center justify-center rounded-2xl border border-destructive/20 bg-destructive/10 animate-fade-up">
      ...
      <p className="mt-4 max-w-md text-base text-muted-foreground animate-fade-up delay-150">
        We've encountered an unexpected error. Please return to the homepage to continue.
      </p>
